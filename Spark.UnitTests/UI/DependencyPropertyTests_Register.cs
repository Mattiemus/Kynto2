namespace Spark.UnitTests.UI
{
    ...
    public class DependencyPropertyTests_Register
    {
        ...
        public void Should_Call_ValidateValueCallback_With_Default_Value()
        {
            ...
            DependencyProperty dp = DependencyProperty.Register(
                "Register_Should_Call_ValidateValueCallback_With_Default_Value",
                typeof(string),
                typeof(TestClass1),
        ...
        {
            DependencyProperty dp = DependencyProperty.Register(
                "Register_Should_Throw_ArgumentException_If_Already_Registered",
                typeof(string),
                typeof(TestClass1));
        ...
        {
            DependencyProperty dp = DependencyProperty.Register(
                "Register_Should_Not_Throw_ArgumentException_If_Already_Registered_On_Base",
                typeof(string),
                typeof(TestClass1));
