...
{
    /// <summary>
    /// Defines a factory that creates platform-specific implementations of type <see cref="IRenderTarget2DImplementation"/>.
    /// </summary>
    public interface IRenderTarget2DImplementationFactory : IGraphicsResourceImplementationFactory
    {
        /// <summary>
        ...
        IRenderTarget2DImplementation CreateImplementation(int width, int height, int mipMapCount, SurfaceFormat format, MSAADescription preferredMSAA, DepthFormat depthFormat, bool preferReadableDepth, RenderTargetUsage targetUsage);
        ...
        /// <returns>The render target implementation</returns>
        IRenderTarget2DImplementation CreateImplementation(SurfaceFormat format, int mipMapCount, IDepthStencilBuffer depthBuffer);
    }
}
