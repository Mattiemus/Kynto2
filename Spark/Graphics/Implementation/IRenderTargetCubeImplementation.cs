...
{
    /// <summary>
    /// Defines an implementation for <see cref="RenderTargetCube"/>.
    /// </summary>
    public interface IRenderTargetCubeImplementation : ITextureCubeImplementation
    {
        /// <summary>
        ...
        IRenderTarget GetSubRenderTarget(CubeMapFace face);
    }
}
