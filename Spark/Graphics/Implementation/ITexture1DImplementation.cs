namespace Spark.Graphics.Implementation
{
    ...
    /// </summary>
    public interface ITexture1DImplementation : IGraphicsResourceImplementation
    {
        /// <summary>
        ...
        void GetData<T>(IDataBuffer<T> data, int mipLevel, ResourceRegion1D? subimage, int startIndex) where T : struct;
        ...
        void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data, int mipLevel, ResourceRegion1D? subimage, int startIndex, DataWriteOptions writeOptions) where T : struct;
    }
}
