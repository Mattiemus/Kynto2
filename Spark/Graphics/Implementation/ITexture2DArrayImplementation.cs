namespace Spark.Graphics.Implementation
{
    ...
    /// <summary>
    /// Defines an implementation for <see cref="Texture2DArray"/>.
    /// </summary>
    public interface ITexture2DArrayImplementation : ITexture2DImplementation
    {
        /// <summary>
        ...
        void GetData<T>(IDataBuffer<T> data, int arraySlice, int mipLevel, ResourceRegion2D? subimage, int startIndex) where T : struct;
        ...
        void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data, int arraySlice, int mipLevel, ResourceRegion2D? subimage, int startIndex, DataWriteOptions writeOptions) where T : struct;
