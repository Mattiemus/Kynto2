...
{
    /// <summary>
    /// Defines a factory that creates platform-specific implementations of type <see cref="ITexture2DArrayImplementation"/>.
    /// </summary>
    public interface ITexture2DArrayImplementationFactory : IGraphicsResourceImplementationFactory
    {
        /// <summary>
        ...
        ITexture2DArrayImplementation CreateImplementation(int width, int height, int arrayCount, int mipMapCount, SurfaceFormat format, ResourceUsage resourceUsage);
        ...
        /// <returns>The texture implementation.</returns>
        ITexture2DArrayImplementation CreateImplementation(int width, int height, int arrayCount, int mipMapCount, SurfaceFormat format, ResourceUsage resourceUsage, params IReadOnlyDataBuffer[] data);
    }
}
