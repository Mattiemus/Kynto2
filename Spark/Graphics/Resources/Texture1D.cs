namespace Spark.Graphics
{
    ...
    public class Texture1D : Texture
    {
        ...
        public Texture1D(IRenderSystem renderSystem, int width)
        {
            CreateImplementation(renderSystem, width, false, SurfaceFormat.Color, ResourceUsage.Static);
        }
        ...
        public Texture1D(IRenderSystem renderSystem, int width, ResourceUsage resourceUsage)
        {
            CreateImplementation(renderSystem, width, false, SurfaceFormat.Color, resourceUsage);
        }
        ...
        public Texture1D(IRenderSystem renderSystem, int width, bool genMipMaps, SurfaceFormat format)
        {
            CreateImplementation(renderSystem, width, genMipMaps, format, ResourceUsage.Static);
        }
        ...
        /// <param name="format">Surface format of the texture.</param>
        /// <param name="resourceUsage">Resource usage specifying the type of memory the texture should use.</param>
        public Texture1D(IRenderSystem renderSystem, int width, bool genMipMaps, SurfaceFormat format, ResourceUsage resourceUsage)
        {
            CreateImplementation(renderSystem, width, genMipMaps, format, resourceUsage);
        }
        ...
        public Texture1D(IRenderSystem renderSystem, int width, SurfaceFormat format, IReadOnlyDataBuffer data)
        {
            CreateImplementation(renderSystem, width, false, format, ResourceUsage.Static, data);
        }
        ...
        /// <param name="resourceUsage">Resource usage specifying the type of memory the texture should use.</param>
        /// <param name="data">Data to initialize the texture's first mip level with, the data buffer must not exceed the size of the mip level and is permitted to be null.</param>
        public Texture1D(IRenderSystem renderSystem, int width, SurfaceFormat format, ResourceUsage resourceUsage, IReadOnlyDataBuffer data)
        {
            CreateImplementation(renderSystem, width, false, format, resourceUsage, data);
        }
        ...
        public Texture1D(IRenderSystem renderSystem, int width, bool genMipMaps, SurfaceFormat format, params IReadOnlyDataBuffer[] data)
        {
            CreateImplementation(renderSystem, width, genMipMaps, format, ResourceUsage.Static, data);
        }
        ...
        /// <param name="data">Data to initialize the texture with, the array length must not exceed the number of mip levels and each data buffer must not exceed the size of the corresponding mip level, and is
        /// permitted to be null.</param>
        public Texture1D(IRenderSystem renderSystem, int width, bool genMipMaps, SurfaceFormat format, ResourceUsage resourceUsage, params IReadOnlyDataBuffer[] data)
        {
            CreateImplementation(renderSystem, width, genMipMaps, format, resourceUsage, data);
        }

        /// <summary>
        /// Gets the format of the texture resource.
        /// </summary>
        public override SurfaceFormat Format => Texture1DImplementation.Format;

        /// <summary>
        /// Gets the number of mip map levels in the texture resource. Mip levels may be indexed in the range of [0, MipCount).
        /// </summary>
        public override int MipCount => Texture1DImplementation.MipCount;

        /// <summary>
        /// Gets the texture dimension, identifying the shape of the texture resoure.
        /// </summary>
        public override TextureDimension Dimension => TextureDimension.One;

        /// <summary>
        /// Gets the resource usage of the texture.
        /// </summary>
        public override ResourceUsage ResourceUsage => Texture1DImplementation.ResourceUsage;

        /// <summary>
        /// Gets the shader resource type.
        /// </summary>
        public override ShaderResourceType ResourceType => ShaderResourceType.Texture1D;

        /// <summary>
        /// Gets the texture width, in texels.
        /// </summary>
        public int Width => Texture1DImplementation.Width;

        /// <summary>
        /// Gets the texture 1D implementation
        /// </summary>
        private ITexture1DImplementation Texture1DImplementation
        {
            get => Implementation as ITexture1DImplementation;
        ...
        public void GetData<T>(IDataBuffer<T> data) where T : struct
        {
            ...
            try
            {
                Texture1DImplementation.GetData(data, 0, null, 0);
            }
            catch (Exception e)
            {
        ...
        public void GetData<T>(IDataBuffer<T> data, ResourceRegion1D? subimage) where T : struct
        {
            ThrowIfDisposed();

            try
            {
                Texture1DImplementation.GetData(data, 0, subimage, 0);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error reading from resource", e);
        ...
        public void GetData<T>(IDataBuffer<T> data, int mipLevel, ResourceRegion1D? subimage, int startIndex) where T : struct
        {
            ...
            try
            {
                Texture1DImplementation.GetData(data, mipLevel, subimage, startIndex);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error reading from resource", e);
        ...
        public void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data) where T : struct
        {
            ...
            try
            {
                Texture1DImplementation.SetData(renderContext, data, 0, null, 0, DataWriteOptions.Discard);
            }
            catch (Exception e)
            {
        ...
        public void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data, DataWriteOptions writeOptions) where T : struct
        {
            ...
            try
            {
                Texture1DImplementation.SetData(renderContext, data, 0, null, 0, writeOptions);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error writing to resource", e);
        ...
        public void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data, ResourceRegion1D? subimage) where T : struct
        {
            ThrowIfDisposed();
            ThrowIfDefferedSetDataIsNotPermitted(renderContext, ResourceUsage);
            ...
            try
            {
                Texture1DImplementation.SetData(renderContext, data, 0, subimage, 0, DataWriteOptions.Discard);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error writing to resource", e);
        ...
        /// <param name="subimage">The subimage region, in texels, of the 1D texture to write to, if null the whole image is written to.</param>
        /// <param name="writeOptions">Writing options, valid only for dynamic textures.</param>
        public void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data, ResourceRegion1D? subimage, DataWriteOptions writeOptions) where T : struct
        {
            ThrowIfDisposed();
            ThrowIfDefferedSetDataIsNotPermitted(renderContext, ResourceUsage);
            ...
            try
            {
                Texture1DImplementation.SetData(renderContext, data, 0, subimage, 0, writeOptions);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error writing to resource", e);
        ...
        public void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data, int mipLevel, ResourceRegion1D? subimage, int startIndex) where T : struct
        {
            ThrowIfDisposed();
            ThrowIfDefferedSetDataIsNotPermitted(renderContext, ResourceUsage);
            ...
            try
            {
                Texture1DImplementation.SetData(renderContext, data, mipLevel, subimage, startIndex, DataWriteOptions.Discard);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error writing to resource", e);
        ...
        public void SetData<T>(IRenderContext renderContext, IReadOnlyDataBuffer<T> data, int mipLevel, ResourceRegion1D? subimage, int startIndex, DataWriteOptions writeOptions) where T : struct
        {
            ...
            try
            {
                Texture1DImplementation.SetData(renderContext, data, mipLevel, subimage, startIndex, writeOptions);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error writing to resource", e);
        ...
        public override void Read(ISavableReader input)
        {
            ...
            CreateImplementation(renderSystem, width, mipCount > 1, format, resourceUsage, dataArray);
        }
        ...
        {
            ITexture1DImplementation impl = Texture1DImplementation;
            ...
            for (int i = 0; i < mipCount; i++)
            {
                IDataBuffer<byte> byteBuffer = DataBuffer<byte>.Create(CalculateMipLevelSizeInBytes(i, width, format));
        ...
        protected void ValidateCreationParameters(IGraphicsAdapter adapter, int width, SurfaceFormat format)
        {
        ...
        protected void ValidateCreationParameters(IGraphicsAdapter adapter, int width, int mipCount, SurfaceFormat format, params IReadOnlyDataBuffer[] data)
        {
            ValidateCreationParameters(adapter, width, format);
        ...
        private void CreateImplementation(IRenderSystem renderSystem, int width, bool genMipMaps, SurfaceFormat format, ResourceUsage resourceUsage)
        {
            ...
            ValidateCreationParameters(renderSystem.Adapter, width, format);
            
            if (!renderSystem.TryGetImplementationFactory(out ITexture1DImplementationFactory factory))
            {
            ...
            try
            {
                Texture1DImplementation = factory.CreateImplementation(width, mipLevels, format, resourceUsage);
            }
            catch (Exception e)
            {
        ...
        private void CreateImplementation(IRenderSystem renderSystem, int width, bool genMipMaps, SurfaceFormat format, ResourceUsage resourceUsage, params IReadOnlyDataBuffer[] data)
        {
            if (renderSystem == null)
            {
                throw new ArgumentNullException(nameof(renderSystem), "Render system cannot be null");
            ...
            ValidateCreationParameters(renderSystem.Adapter, width, mipLevels, format, data);
            ...
            try
            {
                Texture1DImplementation = factory.CreateImplementation(width, mipLevels, format, resourceUsage, data);
            }
            catch (Exception e)
            {
                throw new SparkGraphicsException("Error while creating implementation", e);
