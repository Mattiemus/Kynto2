...
//            finally
//            {
//                Logger.Info("Network receive thread exited.");
//            }
//        }
...
//            {
//                Logger.Warn("Packet has been already received: " + packet.PacketId);
...
//            finally
//            {
//                Logger.Info("Network thread exited.");
//            }
//        }
...
//                            Logger.Warn("Resending packet: " + packetToAck.PacketId + " for " + packetToAck.ResendCount + " time.");
//                        }
//                    }
//                }
...
//                    {
//                        Logger.Warn("Exceeding transmission limit. Dropping unguaranteed messages.");
...
//                {
//                    session.SessionState = SessionState.Disconnected;
//                    Logger.Info("Session timed out: " + session.IncomingSessionId + " (" + (session.IsIncoming ? "from" : "to") + " " + session.RemoteEndPoint.Address + ":" + session.RemoteEndPoint.Port + ")");
//                }

//                if (session.IsDisconnected)
//                {
//                    _sessionsToRemove.Add(session);
//                    Logger.Info("Session destructed: " + session.IncomingSessionId + " (" + (session.IsIncoming ? "from" : "to") + " " + session.RemoteEndPoint.Address + ":" + session.RemoteEndPoint.Port + ")");
//                }
//            }
...
//                        Logger.Debug("Incoming session constructed: " + session.IncomingSessionId + " (" + (session.IsIncoming ? "from" : "to") + " " + session.RemoteEndPoint.Address + ":" + session.RemoteEndPoint.Port + ")");
...
//                            {
//                                Logger.Warn("Incoming packet could not be tied to session - incomingSessionId: " + incomingSessionId + " message type:" + messageType);
//                                return null;
//                            }
...
//                                session.IncomingSessionId = incomingSessionId;
//                                _inKeySessionDictionary.Add(sessionKey, session);
//                                Logger.Debug("Session id received from peer: " + session.IncomingSessionId + " (" + (session.IsIncoming ? "from" : "to") + " " + session.RemoteEndPoint.Address + ":" + session.RemoteEndPoint.Port + ")");
//                                return session;
//                            }
//                            else
//                            {
//                                Logger.Warn("Incoming ack packet could not be tied to session. - incomingSessionId: " + incomingSessionId + " message type:" + messageType);
//                                return null;
//                            }
//                        }
//                        else
...
//                            Logger.Debug("Outgoing session constructed: " + session.IncomingSessionId + " (" + (session.IsIncoming ? "from" : "to") + " " + session.RemoteEndPoint.Address + ":" + session.RemoteEndPoint.Port + ")");
